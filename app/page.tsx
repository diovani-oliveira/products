...
const stats2 = [
  { id: 1, name: 'Segunda-Feira', value: '13 às 18' },
  { id: 2, name: 'Terça à Sexta', value: '8 às 18' },
  { id: 3, name: 'Sábado', value: '10 às 17' },
  ...
  return (
    <main>
      ...
      <div className="relative isolate overflow-hidden bg-black py-24 sm:py-32">
        ...
        >
          <div
            className="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-tr from-[#000000] to-[#ffffff] opacity-20"
            style={{
              clipPath:
                'polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)',
            }}
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
            ...
            <dl className="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
              {stats1.map((stat1) => (
                <div key={stat1.name} className="flex flex-col-reverse">
                  <dt className="text-base leading-7 text-gray-300">{stat1.name}</dt>
                  <dd className="text-2xl font-bold leading-9 tracking-tight text-white">{stat1.value}</dd>
                </div>
              ))}
            </dl>
          </div>
          ...
          <dl className="grid grid-cols-1 gap-x-8 gap-y-16 text-center ssm:grid-cols-2 lg:grid-cols-4">
            {stats2.map((stat2) => (
              <div key={stat2.id} className="mx-auto flex max-w-xs flex-col gap-y-4">
                <dt className="text-base leading-7 text-gray-700">{stat2.name}</dt>
